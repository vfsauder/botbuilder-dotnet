...
namespace Microsoft.Bot.Schema
{
    ...
    public partial class AnimationCard
    {
        ...
        public AnimationCard(string title = default(string), string subtitle = default(string), string text = default(string), ThumbnailUrl image = default(ThumbnailUrl), List<MediaUrl> media = default(List<MediaUrl>), List<CardAction> buttons = default(List<CardAction>), bool? shareable = default(bool?), bool? autoloop = default(bool?), bool? autostart = default(bool?), string aspect = default(string), object value = default(object))
        {
            Title = title;
            Subtitle = subtitle;
            Text = text;
