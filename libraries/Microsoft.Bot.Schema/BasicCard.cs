...
namespace Microsoft.Bot.Schema
{
    ...
    public partial class BasicCard
    {
        ...
        public BasicCard(string title = default(string), string subtitle = default(string), string text = default(string), List<CardImage> images = default(List<CardImage>), List<CardAction> buttons = default(List<CardAction>), CardAction tap = default(CardAction))
        {
            Title = title;
            Subtitle = subtitle;
            Text = text;
